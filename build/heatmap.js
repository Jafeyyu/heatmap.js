...
var Canvas2dRenderer = (function Canvas2dRendererClosure() {
  ...
  function Canvas2dRenderer(config) {
    ...
    const notSetContainerPosition = config.notSetContainerPosition || false
    if (!notSetContainerPosition) {
  ...
  Canvas2dRenderer.prototype = {
    ...
    _setStyles: function (config) {
      ...
      if (config.transform) {
        this.canvas.style.transform = config.transform
      }
  ...
  Heatmap.prototype = {
    ...
    configure: function (config) {
      ...
      if (radius === undefined || radius === null) {
        ...
        this._store.updateCfgRadius(radius)
        var internalData = this._store._getInternalData()
        var radi = internalData.radi?.map((item) => item?.map((item) => radius))
        internalData.radi = radi
        this._coordinator.emit('renderall', internalData)
      }
